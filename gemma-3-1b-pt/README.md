...
4.  **Deploy NIM:**
    ...
    With Multi-NIM, we can specify the model to be served using the `NIM_MODEL_NAME` environment variable. In this case, we are setting it to `"google/gemma-3-1b-pt"` to serve the Gemma-3-1b-pt model.
